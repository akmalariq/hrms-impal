                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php else : ?>
                                    ...
                                    <?php if ($student) : ?>
                                        <a href="<?= base_url("admin/deletecourse/") . $assigned_user['id'] . "/" . 2 . "/" . $c['id'] . "/" . 2 ?>" class="btn btn-danger">Delete</a>
                                    <?php else : ?>
                                        <a href="<?= base_url("admin/addcourse/") . $assigned_user['id'] . "/" . $c['id'] . "/" . 2 ?>" class="btn btn-success">Assign</a>
                                    <?php endif; ?>
                                <?php endif; ?>
                            </td>
                        </tr>
